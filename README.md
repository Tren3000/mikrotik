...
+ **<font color="green">RussianIP</font>** - список всех сетей и масок, принадлежащих РФ. Создаётся address list  и добавляется правило в RAW , по запрету доступа к L2TP, НЕ из диапазона address list RussianIP, до обработки firewall, для снижения нагрузки на железо. При желании, можно изменить протокол, на свой. 

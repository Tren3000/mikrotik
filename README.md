...
+ **<span style="color:#ff0000">RussianIP(HEX)</span>** - список всех сетей и масок, <span style="color:blue">принадлежащих</span> РФ. Создаётся address list  и добавляется правило в RAW , по запрету доступа к L2TP, НЕ из диапазона address list RussianIP, до обработки firewall, для снижения нагрузки на железо. При желании, можно изменить протокол, на свой. 
